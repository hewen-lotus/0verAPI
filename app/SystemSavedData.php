 ...
 * @method static \Illuminate\Database\Query\Builder|\App\SystemSavedData whereHistoryId($value)
 * @method static \Illuminate\Database\Query\Builder|\App\SystemSavedData whereIpAddress($value)
 * @method static \Illuminate\Database\Query\Builder|\App\SystemSavedData whereLastYearAdmissionAmount($value)
 * @method static \Illuminate\Database\Query\Builder|\App\SystemSavedData whereLastYearSurplusAdmissionQuota($value)
 * @method static \Illuminate\Database\Query\Builder|\App\SystemSavedData whereModifiedBy($value)
 * @method static \Illuminate\Database\Query\Builder|\App\SystemSavedData whereQuantityModifiedBy($value)
 * @method static \Illuminate\Database\Query\Builder|\App\SystemSavedData whereRatifyExpandedQuota($value)
 * @method static \Illuminate\Database\Query\Builder|\App\SystemSavedData whereRatifyQuotaForSelfEnrollment($value)
 * @method static \Illuminate\Database\Query\Builder|\App\SystemSavedData whereTypeId($value)
 */
