...
class SyncHistoryDataToFormalController extends Controller
{
    ...
    public function bachelor($school_code)
    {
        if (SchoolHistoryData::where('id', '=', $school_code)
            ...
            if (DB::table('system_data')->where('type_id', 1)->where('school_code', $school_code)->exists()) {
                DB::table('system_data')->where('type_id', 1)->where('school_code', $school_code)
                    ->update([
    ...
    public function two_year($school_code)
    {
        if (SchoolHistoryData::where('id', '=', $school_code)
            ->whereHas('systems', function ($query) {
