 ...
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereAdmissionPlacementRatifyQuota($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereAdmissionSelectionQuota($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereAdmissionSelectionRatifyQuota($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereApprovalDocOfSpecialClass($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereBirthLimitAfter($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereBirthLimitBefore($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereDescription($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereEngDescription($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereEngMemo($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereEngReviewFeeDetail($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereGenderLimit($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereHasBirthLimit($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereHasBuHweiHwaWen($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereHasDisabilities($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereHasEngTaught($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereHasForeignSpecialClass($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereHasReviewFee($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereHasSelfEnrollment($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereHasSpecialClass($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereHistoryId($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereIpAddress($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereMainGroup($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereMemo($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereModifiedBy($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereQuantityModifiedBy($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereRank($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereReviewFeeDetail($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereSelfEnrollmentQuota($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereSelfEnrollmentRatifyQuota($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereSpecialDeptType($value)
 * @method static \Illuminate\Database\Query\Builder|\App\TwoYearTechDepartmentSavedData whereSubGroup($value)
 */
class TwoYearTechDepartmentSavedData extends Model
{
    use SoftDeletes;

    protected $table = 'two_year_tech_department_saved_data';
